...
public class Triangle {
    ...
    public Triangle(String name, double leftSide, double rightSide, double middleSide) {
        this();
        this.name = name;
        if (!triangleSidesValidator(leftSide, rightSide, middleSide)) {
    ...
    private static boolean triangleSidesValidator(double a, double b, double c) {
        ...
        return compareDoubles(c, (a + b)) == -1 && compareDoubles(a, c + b) == -1 && compareDoubles(b, a + c) == -1;
    }
